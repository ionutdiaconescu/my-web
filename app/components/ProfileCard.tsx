          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="flex items-center gap-3 group">
              <a
                ...
                className="inline-flex items-center gap-3 rounded-full border border-accent bg-primary/60 px-4 py-2.5 text-foreground shadow-sm transition-all hover:scale-[1.02] hover:shadow-md hover:text-accent"
              >
